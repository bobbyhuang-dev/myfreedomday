...
description: Astro builds a static site; Markdown lives in the repo; Pages serves the build output.
---
...
3. Cloudflare Pages uploads the `dist/` folder and serves it globally from the edge.
